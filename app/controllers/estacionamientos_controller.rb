class EstacionamientosController < ApplicationController
  ...
  private
    ...
    def estacionamiento_params
      params.require(:estacionamiento).permit(:Direccion_esta, :Departamento_esta, :Disponibilidad_esta, :Codigo_esta, :Tipo_esta, :Tipo_alquiler_esta, :Tarifa_esta, :Otras_caracteristicas)
    end
end
