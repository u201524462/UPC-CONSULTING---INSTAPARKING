...
class VehicleTypesControllerTest < ActionController::TestCase
  ...
  test "should create vehicle_type" do
    assert_difference('VehicleType.count') do
      post :create, vehicle_type: { flag1: @vehicle_type.flag1, flag2: @vehicle_type.flag2, long_description: @vehicle_type.long_description, short_description: @vehicle_type.short_description }
    end
  ...
  test "should update vehicle_type" do
    patch :update, id: @vehicle_type, vehicle_type: { flag1: @vehicle_type.flag1, flag2: @vehicle_type.flag2, long_description: @vehicle_type.long_description, short_description: @vehicle_type.short_description }
    assert_redirected_to vehicle_type_path(assigns(:vehicle_type))
  end
